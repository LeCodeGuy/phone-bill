...
function updateBillSettings(){
    callCostSettingVal = callCostSettingElem.value;
    smsCostSettingVal = smsCostSettingElem.value;
    warningLevelSettingVal = warningLevelSettingElem.value;
    criticalLevelSettingVal = criticalLevelSettingElem.value;
